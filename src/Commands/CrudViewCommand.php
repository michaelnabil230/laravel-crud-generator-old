...
class CrudViewCommand extends Command
{
    ...
    public function __construct()
    {
        ...
        if (config('crud-generator.view_columns_number')) {
            $this->defaultColumnsToShow = config('crud-generator.view_columns_number');
        }

        $this->delimiter = config('crud-generator.custom_delimiter', ['%%', '%%']);
    }
    ...
    {
        $this->viewDirectoryPath = config('crud-generator.custom_template')
        ...
        $this->viewName = Str::snake(Str::plural($this->argument('name')), '-');
    ...
    {
        $dynamicViewTemplate = config('crud-generator.dynamic_view_template')
            ? config('crud-generator.dynamic_view_template')
